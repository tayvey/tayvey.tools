...
//        private ConcurrentDictionary<string, TvTcpClient> Clients { get; } = new();
//#else
//        private ConcurrentDictionary<string, TvTcpClient> Clients { get; } = new ConcurrentDictionary<string, TvTcpClient>();
//#endif
...
//        /// <returns></returns>
//        private Task ClientDisposeCallBackAsync(TvTcpClient client) => Task.Run(() =>
//        {
